            ...
            perform_update: function(value, on_success){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.valid) {
                            valid_msg.html('<span style="font-weight: bold; color: #0c0">Dieser Datensatzname ist gültig.</span>');
                        } else {
                            valid_msg.html('<span style="font-weight: bold; color: #c00">Dieser Datensatzname ist schon vergeben, bitte einen anderen wählen oder ggf. eine Zahl anhängen.</span>');
                        }
                    }
                });
            },
